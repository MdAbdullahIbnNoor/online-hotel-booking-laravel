                    ...
                    <form action="{{ route('admin_video_update',$video_data->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div>
                                    <iframe width="250" height="140.5" src="https://www.youtube.com/embed/{{ $video_data->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                </div>
                                <div class="mb-4">
