                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="contact_map" value="{{ $page_data->contact_map }}">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Status *</label>
                                    <select name="contact_status" class="form-control">
                                        <option value="1" @if ($page_data->contact_status == 1)
                                            selected
                                        @endif>Show</option>
                                        <option value="0" @if ($page_data->contact_status == 0)
                                            selected
                                        @endif>Hide</option>
                                    </select>
                                </div>
