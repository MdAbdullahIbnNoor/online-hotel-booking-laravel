                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <td>Laptop</td> --}}
                                    <td>
                                        <iframe width="250" height="140.5" src="https://www.youtube.com/embed/{{ $row->video_id }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </td>
                                    <td>{{ $row->caption }}</td>
